...
def getAllDicts(dataset_name):
    ...
    base_path = 'data/data/{dataset_name}/kg/tkbc_processed_data/{dataset_name}/'.format(
    ...
    ent2id = dicts['ent_id']
    ts2id = dicts['ts_id']
    file_ent = 'data/data/{dataset_name}/kg/wd_id2entity_text.txt'.format(
        dataset_name=dataset_name
    )
    file_rel = 'data/data/{dataset_name}/kg/wd_id2relation_text.txt'.format(
        dataset_name=dataset_name
    )
